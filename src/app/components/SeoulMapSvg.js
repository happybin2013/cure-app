...
const regionCenters = {
  CD11110: { x: 399, y: 277, name: "종로구", dangerLevel: 1,
  ...
  CD11140: { x: 433, y: 338, name: "중구", dangerLevel: 2,
  ...
  CD11170: { x: 407, y: 395, name: "용산구", dangerLevel: 3,
  ...
  CD11200: { x: 505, y: 356, name: "성동구", dangerLevel: 1,
  ...
  CD11215: { x: 577, y: 365, name: "광진구", dangerLevel: 1,
  ...
  CD11230: { x: 528, y: 294, name: "동대문구", dangerLevel: 2,
  ...
  CD11260: { x: 589, y: 270, name: "중랑구", dangerLevel: 3,
  ...
  CD11290: { x: 466, y: 258, name: "성북구", dangerLevel: 0,
  ...
  CD11305: { x: 459, y: 181, name: "강북구", dangerLevel: 3,
  ...
  CD11320: { x: 494, y: 125, name: "도봉구", dangerLevel: 3,
  ...
  CD11350: { x: 560, y: 153, name: "노원구", dangerLevel: 2,
  ...
  CD11380: { x: 323, y: 218, name: "은평구", dangerLevel: 3,
  ...
  CD11410: { x: 342, y: 302, name: "서대문구", dangerLevel: 0,
  ...
  CD11440: { x: 293, y: 339, name: "마포구", dangerLevel: 0,
  ...
  CD11470: { x: 209, y: 421, name: "강서구", dangerLevel: 2,
  ...
  CD11500: { x: 156, y: 334, name: "양천구", dangerLevel: 0,
  ...
  CD11530: { x: 199, y: 470, name: "구로구", dangerLevel: 0,
  ...
  CD11545: { x: 279, y: 537, name: "금천구", dangerLevel: 0,
  ...
  CD11560: { x: 295, y: 413, name: "영등포구", dangerLevel: 0,
  ...
  CD11590: { x: 361, y: 461, name: "동작구", dangerLevel: 1,
  ...
  CD11620: { x: 353, y: 529, name: "관악구", dangerLevel: 1,
  ...
  CD11650: { x: 481, y: 515, name: "서초구", dangerLevel: 2,
  ...
  CD11680: { x: 533, y: 464, name: "강남구", dangerLevel: 0,
  ...
  CD11710: { x: 624, y: 448, name: "송파구", dangerLevel: 0,
  ...
  CD11740: { x: 675, y: 358, name: "강동구", dangerLevel: 1,
  ...
  const SeoulMapSvg = ({ address }) => {
    ...
    return (
      <>
        <svg viewBox="0 0 780 720" xmlns="http://www.w3.org/2000/svg" className={styles.svgContainer}>
          <defs>
          ...
          <g filter="url(#dropshadow)">
            {Object.keys(regionCenters).map((id) => {
              ...
              const regionDangerLevelClass = getDangerLevelClass(region.dangerLevel);
              return (
                <React.Fragment key={id}>
                  <path
                    id={id}
                    className={`${styles.region} ${region.name === address ? styles.highlight : ''} ${styles[regionDangerLevelClass]}`}
                    d={region.d}
                  ></path>
                  <text className={styles.TEXT} x={region.x} y={region.y}>
                    {region.name}
                  </text>
                </React.Fragment>
              );
        ...
        {dangerLevel !== 0 ? (
          <div className={styles[dangerLevelClass]}>오염 {dangerLevel} 단계 입니다.</div>
        ) : (
          <div>오염 0 단계 입니다.</div>
        )}
      </>
